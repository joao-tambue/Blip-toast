  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-lg':
          '0 0 48px rgba(139, 92, 246, 0.5), 0 8px 40px rgba(59, 130, 246, 0.28)',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': {
            boxShadow:
              '0 0 24px rgba(139, 92, 246, 0.35), 0 0 60px rgba(59, 130, 246, 0.18)',
          },
          '50%': {
            boxShadow:
              '0 0 44px rgba(139, 92, 246, 0.6), 0 0 90px rgba(59, 130, 246, 0.35)',
          },
        },
        shimmer: {
