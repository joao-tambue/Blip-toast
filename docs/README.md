...
Este diretório documenta todas as decisões arquiteturais tomadas durante o desenvolvimento da biblioteca Blip Toast.

## Estrutura de Documentação

Cada arquivo nesta pasta representa uma decisão arquitetural (Architecture Decision Record - ADR) e segue o padrão:
...
- [001-monorepo-structure.md](./001-monorepo-structure.md) - Escolha da estrutura Monorepo
- [002-state-management.md](./002-state-management.md) - Gerenciamento de Estado
- [003-animation-strategy.md](./003-animation-strategy.md) - Estratégia de Animações
